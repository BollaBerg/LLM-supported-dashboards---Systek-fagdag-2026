...
- Krever litt mer å sy sammen tools og AI-svar
- Vanskelig å postprosessere svar

. . .

- Mitigering:
    - Returner strings der mulig
    - Bruk verktøy som ikke krever mye etterbehandling
    - Legg inn forsinkelser der det er behov for det
